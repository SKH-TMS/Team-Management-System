...
function ResetPasswordContent() {
  ...
  const onSubmit = async (values: AdminResetPasswordFormData) => {
    setApiMessage(null);
    setIsSuccess(false);
    if (!token) {
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <LockIcon className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground hover:bg-slate-100" />
                          <Input
